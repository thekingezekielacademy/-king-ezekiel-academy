    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-gradient-to-br from-primary-50 via-white to-secondary-50 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* CTA Section */}
          <div className="bg-white rounded-3xl p-12 text-center shadow-soft border border-primary-100 relative overflow-hidden">
            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-primary-500 to-primary-700"></div>
            <div className="relative z-10">
              <h3 className="text-3xl md:text-4xl font-bold mb-6 text-primary-900">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                <button className="group bg-gradient-to-r from-primary-700 to-primary-900 text-white font-bold py-4 px-8 rounded-xl text-lg transition-all duration-300 transform hover:scale-105 shadow-soft hover:shadow-glow">
                  <span className="mr-2">Subscribe Now — only ₦2,500/month</span>
                  <FaArrowRight className="inline h-5 w-5 group-hover:translate-x-1 transition-transform duration-200" />
                </button>
                <Link 
                  to="/courses" 
                  className="text-primary-600 hover:text-primary-700 font-semibold text-lg transition-colors duration-200 flex items-center"
                >
                  Browse All Courses
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              {/* Stats */}
              <div className="bg-gradient-to-br from-primary-800 to-primary-900 rounded-3xl p-8 shadow-soft">
                <div className="grid grid-cols-2 gap-8">
                  <div className="text-center group">
                    ...
                    <div className="text-sm text-yellow-200 font-medium">Students Taught</div>
                  </div>
                  <div className="text-center group">
                    <div className="w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                      <FaStar className="h-8 w-8 text-white" />
                    </div>
                    <div className="text-3xl font-bold text-yellow-300 mb-2">4.9/5</div>
                    <div className="text-sm text-yellow-200 font-medium">Student Rating</div>
                  </div>
                  <div className="text-center group">
                    <div className="w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                    ...
                    <div className="text-sm text-yellow-200 font-medium">Years Experience</div>
                  </div>
                  <div className="text-center group">
                    <div className="w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                    ...
                    <div className="text-sm text-yellow-200 font-medium">Success Rate</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="text-center">
              <div className="w-24 h-24 bg-gradient-to-br from-primary-100 to-primary-200 rounded-3xl flex items-center justify-center mx-auto mb-8">
                <FaHeart className="h-12 w-12 text-primary-600" />
              </div>
              <h4 className="text-2xl font-semibold text-primary-900 mb-8">Why Students Love Us</h4>
              <div className="space-y-6 text-left">
                <div className="flex items-start space-x-4 p-4 bg-primary-50 rounded-xl">
                  ...
                  <div>
                    <h5 className="font-semibold text-primary-900 mb-1">Comprehensive Course Library</h5>
                    <p className="text-primary-600 text-sm">25+ courses covering all major digital skills</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4 p-4 bg-primary-50 rounded-xl">
                  <FaCheck className="h-6 w-6 text-primary-600 mt-1 flex-shrink-0" />
      ...
      <section className="py-20 bg-gradient-to-br from-secondary-50 to-primary-50 relative overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute top-20 right-20 w-64 h-64 bg-primary-100 rounded-full mix-blend-multiply filter blur-xl opacity-30"></div>
          <div className="absolute bottom-20 left-20 w-64 h-64 bg-secondary-100 rounded-full mix-blend-multiply filter blur-xl opacity-30"></div>
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white rounded-3xl shadow-soft p-8 hover:shadow-glow transition-all duration-300 border border-primary-100 group">
              <div className="w-20 h-20 bg-gradient-to-br from-primary-100 to-primary-200 rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform duration-300">
                <FaLaptopCode className="h-10 w-10 text-primary-600" />
              </div>
              <h3 className="text-xl font-semibold text-primary-900 mb-4">Technology & Innovation</h3>
            ...
            <div className="bg-white rounded-3xl shadow-soft p-8 hover:shadow-glow transition-all duration-300 border border-primary-100 group">
              <div className="w-20 h-20 bg-gradient-to-br from-primary-100 to-primary-200 rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform duration-300">
                <FaChartBar className="h-10 w-10 text-primary-600" />
              </div>
              <h3 className="text-xl font-semibold text-primary-900 mb-4">Business & Leadership</h3>
              <p className="text-primary-600 mb-6 leading-relaxed">
            ...
            <div className="bg-white rounded-3xl shadow-soft p-8 hover:shadow-glow transition-all duration-300 border border-primary-100 group">
              <div className="w-20 h-20 bg-gradient-to-br from-primary-100 to-primary-200 rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform duration-300">
                <FaPalette className="h-10 w-10 text-primary-600" />
              </div>
              <h3 className="text-xl font-semibold text-primary-900 mb-4">Creative Arts</h3>
              <p className="text-primary-600 mb-6 leading-relaxed">
            ...
            <div className="bg-white rounded-3xl shadow-soft p-8 hover:shadow-glow transition-all duration-300 border border-primary-100 group">
              <div className="w-20 h-20 bg-gradient-to-br from-primary-100 to-primary-200 rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform duration-300">
                <FaGlobe className="h-10 w-10 text-primary-600" />
              </div>
              <h3 className="text-xl font-semibold text-primary-900 mb-4">Global Studies</h3>
              <p className="text-primary-600 mb-6 leading-relaxed">
